...
#include <math.h>
FILE *fr, *fi, *fw, *fl;
char fnamei[122]="/Users/khomma/work/disopred/rdisopr12";               /* DISOPRED3 results including variant data */
char fnamer[122]="/Users/khomma/work/ensembl/rice/ralluniqexon3A";	/* #### Corrected list of ALL internal exons */
char fnamew[122]="/Users/khomma/work/ensembl/rice/rgintexst6M";		/* ### Avg and median values */
char fnamel[122]="/Users/khomma/work/ensembl/rice/rgintexstlist6M";	/* ### List of data */
...
void assign(void)	/* Find the SD assignments, if any */
{
	...
	strncpy(istr,empty,5001);
		...
		if(istr[0]=='>' && strstr(istr,entryname)!=NULL){	/* Possible hit. I do not use abbentname */
			ihit = 1;
		}
...
int main(void)
{
	...
	strncpy(rstr,empty,5001);
		...
		if(rstr[0]=='>')	goto nextu;
			...
			++excount;
			if(excount%5000==0)	printf("Now processing exon %d out of 144,189...\n",excount);	 /* #### */
