/* mrinsidrGA.c	This program determines the %IDR in inserted segments and that in other regions 	220519
	...
	-> mrinsidr5MA.c: Modified to make use of DICHOT instead of POODLE-L results [R2205 II].
	-> mrinsidr5G.c: Modified to use a new list of inserted segments [R2205 II].  	  */
...
char fnamer[122]="/Users/khomma/work/dichot/mdichotall1";	/* All DICHOT results */
...
char fnamew[122]="/Users/khomma/work/ensembl/hmr/mrinsidr5G";
char instr[10000][51];
...
int main(void)
{
	...
	strncpy(protid,empty,51);	strncpy(trid,empty,51);		plen = -1; 	imax = -1;	hitflag = 0;
		...
		if(rstr[0]=='>'){
			++counter;
			if(counter%1000==0)	printf("Now processing entry %d out of 51,229...\n",counter);
			hitflag = 1;
			offset = 1;
			for(x=0; x<50; x++){
