...
int main(void)
{
	char fnamer[122]="/Users/khomma/work/ensembl/mouse/malluniqexon3";		/* List of nonredundant exons */
	char fnamew[122]="/Users/khomma/work/ensembl/mouse/malluniqexon3A";		/* List of internal exons */
