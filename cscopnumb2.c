...
char fnamel[100]="/Users/khomma/work/ensembl/cele/calluniqexon3";       /* #### Non-redundant list of exons, By new def. */
char fnamew[122]="/Users/khomma/work/ensembl/cele/cscopnumb2";      /* #### */
...
int gpmax[4]={0,296,395,588}, gpnumb;	/* ### Max protein length in each length group */
	...
	for(x=0; x<100000; x++) cdslen[x] = 0;
		...
		if(rstr[0]=='>'){
			...
			if(counter%1000==0)	printf("Now processing variant %d\n",counter);
                        ...
                        /* #&# Convert WBGene9977_388 into  WBGene00009977, for example */
