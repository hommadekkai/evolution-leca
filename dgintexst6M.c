...
#include <math.h>
FILE *fr, *fi, *fw, *fl;
char fnamei[122]="/Users/khomma/work/disopred/ddisopr12";               /* DISOPRED3 results including variant data */
char fnamer[122]="/Users/khomma/work/ensembl/dmel/dalluniqexon3A";      /* ### New list of ALL internal exons */
char fnamew[122]="/Users/khomma/work/ensembl/dmel/dgintexst6M";          /* ### Avg and median valued */
char fnamel[122]="/Users/khomma/work/ensembl/dmel/dgintexstlist6M";      /* ### List of data */
...
int main(void)
{
	...
	strncpy(rstr,empty,5001);
		...
		if(rstr[0]=='>')	goto nextu;
			...
			++excount;
			if(excount%5000==0)	printf("Now processing exon %d out of 37,952...\n",excount);	 /* #### */
			...
			if(strcmp(ttname,oldtname)==0){	
				...
				strcpy(abbentname,"ENSG");
                                for(x=0; x<40; x++){            /* e.g., FBgn0031208 -> abbentname:ENSG31208 */
                                        if(isprint(entryname[x])==0)    break;
                                        abbentname[x+4] = entryname[x+6];
                                }
