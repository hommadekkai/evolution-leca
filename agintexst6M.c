...
#include <math.h>
FILE *fr, *fi, *fw, *fl;
char fnamei[122]="/Users/khomma/work/disopred/adisopr12";               /* DISOPRED3 results including variant data */
char fnamer[122]="/Users/khomma/work/ensembl/athal0/aalluniqexon3A";	/* #### Corrected list of ALL internal exons */
char fnamew[122]="/Users/khomma/work/ensembl/athal0/agintexst6M";	/* ### Avg and median values */
char fnamel[122]="/Users/khomma/work/ensembl/athal0/agintexstlist6M";	/* ### List of data */
char binstr[10][20]={"All","-120","-240","-360","-480","-600","-720","-840","-960","961-nt"};	/* #### */
char rstr[5001], istr[5001], empty[5010]="", tempstr[21], entryname[51], outstr[500], listread[21];
...
int main(void)
{
	...
	strncpy(rstr,empty,5001);
		...
		else if(strncmp(rstr,"ChrC",4)==0)        goto nextu;               /*  Exclude non-nuclear coded genes */
		else if(strncmp(rstr,"ChrM",4)==0)        goto nextu;               /*  Exclude non-nuclear coded genes */
		else{
			++excount;
			if(excount%5000==0)	printf("Now processing exon %d out of 100,776...\n",excount);	 /* #### */
