...
char fnamer[122]="/Users/khomma/work/ensembl/human/hlongexgenes4";
char fnamel[100]="/Users/khomma/work/uniprot/uniprot_sprot_human211117.dat";
char fnamew[122]="/Users/khomma/work/ensembl/human/hlongingo3";
...
nextr:		strncpy(lstr,empty,5001);
	...
	strncpy(lstr,empty,5001);	oksp = 0;
		...
		if(strncmp(lstr,"ID",2)==0 && strstr(lstr,"_HUMAN")!=NULL){
			oksp = 1;
			++counter;
