...
FILE *fr, *fe, *fw;
char *ps;
char fnamer[122]="/Users/khomma/work/ensembl/hmr/tinsseg1";     /* List of rat-specific regions */
char fnamee[122]="/Users/khomma/work/ensembl/rat/nallexon3";    /* ### Revised list of all rat exons */
char fnamew[122]="/Users/khomma/work/ensembl/hmr/trinsexon1G";  /* #+# */
...
int  allowance=1;               /* #+# */
double gw, gx, gy, gz;
void segread(void){    /* Parse the rat-specific segment string get the start and end of each segment */
...
void tread(void){    /* Parse the line to get the start and end of the terminal exon */
...
int main(void)
{
	...
	strncpy(sstr,empty,5001);
		...
		if(strstr(sstr,"ENSRNOT")==NULL)	goto nexts;
		++counter;
			...
			if(vlist[0].totex==1){		/* #&# */	
				...
				for(y=0; y<=varmax; y++){
					if(hitexon[y]==2){	/* One exon */
						...
						else			nexon = 5;	/* #&# An int. exon w/ coinc. */
						break;	
					}
				}
