/* mgintexst5M.c  This program determines the median # of residues in SD in each exon length range of all genuine internal exons  220206
	basic.c -> hnmdcnumb1.c: A new program [R1906 I].		  
	 ...
	 -> mgintexst5M.c: Modified to use DICHOT instead of POODLE-L results [R2202 VII]. */
...
#include <math.h>
FILE *fr, *fi, *fw, *fl, *fc;		/* ##### */
char fnamei[122]="/Users/khomma/work/dichot/mdichotall1";               /* DICHOT results including variant data */
char fnamer[122]="/Users/khomma/work/ensembl/mouse/malluniqexon3A";	/* #### Corrected list of ALL internal exons */
char fnamew[122]="/Users/khomma/work/ensembl/mouse/mgintexst5M";	/* ### Avg and median values */
char fnamel[122]="/Users/khomma/work/ensembl/mouse/mgintexstlist5M";	/* ### List of data */
...
ctot:	/* Calculate the total of all exon length bins */
	...
	fputs("DICOHT\tLen. range\tNumber\tAvg len\tSEM\tAvg SD res.\t SEM\tAvg %SD\tSEM\n",fw);
