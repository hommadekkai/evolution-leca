/* mscopadd3AM.c		This program determines the max internal exon length downstream of SCOP domains		220811
	 ...
	 -> mscopadd3A.c: Modified to randomly neglect 1/2 of SCOP domains (#++#) [R2208 VII].
	 -> mscopadd3AM.c: Modified to use a redundant instead of nonredundant exon list (#++#) [R2208 VII]. */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
char fnamew[122]="/Users/khomma/work/ensembl/mouse/mscopadd3AM";        /* #+++# */
