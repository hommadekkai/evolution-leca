/* falluniqexon3M.c		This program removes redundancy in ALL exons				220503
	basic.c -> huniqexon1.c: A new program [R2011 I].
	 ...
	 -> halluniqexon3M.c: Modified to add the CDS length encoded by internal exons (aa) [R2204 I].
	 -> falluniqexon3M.c: Modified to process fission yeast instead of human data [R2204 IV]. 		  */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
int main(void)
{
        char fnamer[122]="/Users/khomma/work/ensembl/spomb/fallexon3M";          /* List of all genuine exons */
        char fnamew[122]="/Users/khomma/work/ensembl/spomb/falluniqexon3M";
