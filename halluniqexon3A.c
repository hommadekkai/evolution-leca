...
int main(void)
{
	char fnamer[122]="/Users/khomma/work/ensembl/human/halluniqexon3";		/* List of nonredundant exons */
	char fnamew[122]="/Users/khomma/work/ensembl/human/halluniqexon3A";		/* List of internal exons */
