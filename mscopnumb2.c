/* mscopnumb2.c		This program compares the obs. freq. of SCOP at exon boundaries with the expected freq.		220426
	 ...
	 -> hscopnumb2.c: Revised to divide proteins into 4 gps by length and find if corr. is observed in each gp (###) [R2208 I].
	 -> mscopnumb2.c: Revised to use a list of internal exons by a corrected definition (####) [R2208 VII]. */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
char fnamel[100]="/Users/khomma/work/ensembl/mouse/malluniqexon3";      /* #### Non-redundant list of exons, By new def. */
char fnamew[122]="/Users/khomma/work/ensembl/mouse/mscopnumb2";     /* #### */
