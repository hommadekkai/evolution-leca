/* minsconstex3.c	This program compares the obs. freq. of ins segs in constrained exons with the expected freq.		220518
	 ...
	 -> mexonscopavg3.c: Modified to process mouse instead of human data [R2106 VII].
	 -> mrexonscopavg3.c: Revised to use a list of internal exons by a corrected definition [R2204 VII].
	 -> mrexonscopavg3A.c: Modified to use the avg of the exp values of all proteins as the exp value [R2204 VII].
	 -> minsscop1A.c: Revised to calculate the fraction of ins segs in SCOP domains instead [R2205 V].
	 -> minsscop1.c: Revised not to neglect proteins without SCOP alignments (###) [R2205 V].
	 -> minsscop2.c: Revised to analyze insertion inside (instead of 5' or 3' term) of internal exons (####) [R2205 V].
	 -> minsscop3.c: Revised to analyze 5', 3', and inside insertions to internal exons [R2205 V].
	 -> minconstex1A.c: Revised to analyze the freq. of ins in constrained exons instead of SCOP domains [R2205 V].
	 -> minsconstex1.c: Modified not to neglect genes without SCOP domains (#+#) [R2205 V].
	 -> minsconstex2.c: Revised to use ins excluding those that coincide with exon boundaries within 1 instead of 5 aa,
                        and to determine the dependence on exon length (#-#).
	 -> minsconstex3.c: Modified to use the exp values of all introns (R2204 mscopconstex3).  */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
char fnamei[122]="/Users/khomma/work/ensembl/hmr/mrinsexon1G";		/* #-# Classified list of inserted segments */
char fnamer[122]="/Users/khomma/work/ensembl/mouse/mscoplist12";
char fnamel[100]="/Users/khomma/work/ensembl/mouse/malluniqexon3M";	/* Non-redundant list of exons, with the CDS range by int exons */
char fnamew[122]="/Users/khomma/work/ensembl/hmr/minsconstex3";		/* #-# */
...
double gexp[10]={31.088,34.203,29.633,21.607,17.973,15.754,17.086,19.719,18.178,16.090};	/* From R2204 mscopconstex3 */
