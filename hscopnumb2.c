...
char fnamel[100]="/Users/khomma/work/ensembl/human/halluniqexon3";	/* Non-redundant list of exons, By new def. */
char fnamew[122]="/Users/khomma/work/ensembl/human/hscopnumb2";		/* ### */
...
int exlen, excdslen, binmax, cdslen[1000000], cmax=-1;
int gpmax[4]={0,262,452,724}, gpnumb;	/* ### Max protein length in each length group */
	...
	for(x=0; x<100000; x++) cdslen[x] = 0;
		...
		if(rstr[0]=='>'){
			...
			if(counter%1000==0)	printf("Now processing variant %d\n",counter);
                        ...
                        /* Convert ENSG6837_401 into ENSG00000006837, for example */
