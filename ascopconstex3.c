...
char fnamer[122]="/Users/khomma/work/ensembl/athal0/ascoplist12";
char fnamel[100]="/Users/khomma/work/ensembl/athal0/aalluniqexon3M";    /* Non-redundant list of exons, with int CDS len */
char fnamew[122]="/Users/khomma/work/ensembl/athal0/ascopconstex3";     /* #+# */
	...
	for(z=0; z<10; z++){	/* 0:All ex len, 1:1~120, 2:~240, 3:~360, 4:~480, 5:~600, 6:~720, 7:~840, 8:~960, 9:961~ bp */
		...
		if(rstr[0]=='>'){
			...
			if(counter%1000==0)	printf("Now processing variant %d\n",counter);
                        ...
                        strncpy(idstr,empty,51);
                        for(x=0; x<50; x++){
                                if(isprint(rstr[x+1])==0 || rstr[x+1]=='_')     break;
                                idstr[x] = rstr[x+1];
                        }
		}
			...
			strncpy(lstr,empty,201);
				...
				if(strncmp(lstr,"ChrC",4)==0 || strncmp(lstr,"ChrM",4)==0)      continue;       /* ### */
