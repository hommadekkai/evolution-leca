...
#include <math.h>
FILE *fr, *fi, *fw, *fl;
char fnamei[122]="/Users/khomma/work/disopred/hdisopr12";               /* DISOPRED3 results including variant data */
char fnamer[122]="/Users/khomma/work/ensembl/human/halluniqexon3A";     /* #### Corrected list of ALL internal exons */
char fnamew[122]="/Users/khomma/work/ensembl/human/hgintexst6M";        /* ### Avg and median values */
char fnamel[122]="/Users/khomma/work/ensembl/human/hgintexstlist6M";    /* ### List of data */
	...
	strncpy(rstr,empty,5001);
		...
		if(rstr[0]=='>')	goto nextu;
			...
			if(strcmp(ttname,oldtname)==0){	
				...
				for(x=0; x<40; x++){		/* e.g., ENSG00000187634 -> abbentname:ENSG187634 */
					if(isprint(entryname[x])==0)	break;
					abbentname[x+4] = entryname[x+9];
				}
