...
char fnamer[122]="/Users/khomma/work/ensembl/athal0/aabbcdnalist1";	/* Abbreviated cDNAs */
char fnamew[122]="/Users/khomma/work/ensembl/athal0/aexdnacomp1";
char fnamee[100]="/Users/khomma/work/ensembl/athal0/aalluniqexon4AB";
...
void exsearch(void){	/* Look for the corresponding exon info. */
	...
	strncpy(estr,empty,501);	hitflag = 0;
		...
		if(strncmp(estr,"ChrC",4)==0)           goto nexte;     /* Neglect nonnuclear genes */
		else if(strncmp(estr,"ChrM",4)==0)      goto nexte;     /* Neglect nonnuclear genes */
