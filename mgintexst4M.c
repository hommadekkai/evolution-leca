/* mgintexst4M.c  This program determines the median # of residues in SD in each exon length range of all genuine internal exons  220204
...
#include <math.h>
FILE *fr, *fi, *fw, *fl, *fc;		/* ##### */
char fnamei[122]="/Users/khomma/work/poodata/mpoodleALL";		/* POODLE-L results including variant data */
char fnamer[122]="/Users/khomma/work/ensembl/mouse/malluniqexon3A";	/* #### Corrected list of ALL internal exons */
char fnamew[122]="/Users/khomma/work/ensembl/mouse/mgintexst4M";	/* ### Avg and median values */
char fnamel[122]="/Users/khomma/work/ensembl/mouse/mgintexstlist4M";	/* ### List of data */
...
ctot:	/* Calculate the total of all exon length bins */
	...
	fputs("POODLE-L\tLen. range\tNumber\tAvg len\tSEM\tAvg SD res.\t SEM\tAvg %SD\tSEM\n",fw);
