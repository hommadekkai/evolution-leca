...
char fnamer[122]="/Users/khomma/work/ensembl/cele/cabbcdnalist1";       /* Abbreviated cDNAs */
char fnamew[122]="/Users/khomma/work/ensembl/cele/cexdnacomp1";
char fnamee[100]="/Users/khomma/work/ensembl/cele/calluniqexon4AB";
...
void exsearch(void){	/* Look for the corresponding exon info. */
	...
	strncpy(estr,empty,501);	hitflag = 0;
		...
		if(strncmp(estr,"MtDNA",5)==0)  goto nexte;    		/* #### Neglect nonnuclear genes */
		else if(estr[0]!='>' && strstr(estr,trid)!=NULL){	/* Possible hit */
			sread(estr);
			if(strcmp(vlist.tname,trid)==0 && numbseq+1==vlist.cdslen+3){   /* #### Verified */
