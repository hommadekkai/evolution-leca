...
int main(void)
{
	...
	char fnamew[122]="/Users/khomma/work/ensembl/rat/tptcorr1";
	...
	for(x=0; x<100000; x++){
		...
		if(strstr(rstr,"ID=CDS:ENSRNOP")!=NULL && strstr(rstr,"Parent=transcript:ENSRNOT")!=NULL){
			ps = strstr(rstr,"ENSRNOP");
